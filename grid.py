...
def draw_level(bgGroup, bg_images, coinGroup, keyGroup, doorGroup):
    for x, y, bg_type in bgGroup:
        ...
        if bg_type == '#':
            ...
            DISPLAYSURF.blit(bg_images['key'], (x * CELLSIZE, y * CELLSIZE))
        elif bg_type == '0':
...
def generate_map_images():
    ...
    bg_images = {}
    bg_images = {'key' : key_img, 'coin' : coin_img, 'door' : door_img, 'grass' : grass_img, 'wall' : wall_img, 'rock1' : rock1_img, 'rock2' : rock2_img, 'rock3' : rock3_img, 'sand' : sand_img}
    return bg_images
